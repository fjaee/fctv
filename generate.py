...
TV_LOGO_MAP = {
    ...
    "ch_ibc":                PH + "ibc-ph.png",
    "ch_ptv":                PH + "ptv-ph.png",
    "ch_net25":              PH + "net25-ph.png",
    "ch_untv":               PH + "untv-ph.png",
    "ch_inctv":              PH + "inc-tv-ph.png",
    "ch_ewtn":               PH + "ewtn-ph.png",
    "ch_smni":               PH + "smni-ph.png",
    "ch_rjtv_29":            PH + "rj-tv-ph.png",
    "ch_dzrh_tv":            PH + "dzrh-tv-ph.png",
    "ch_cinema_one":         PH + "cinema-one-ph.png",
    "ch_cinemo":             PH + "cine-mo-ph.png",
    "ch_cinemax":            PH + "cinemax-ph.png",
    "ch_hbo":                PH + "hbo-ph.png",
    "ch_hbo_hits":           PH + "hbo-hits-ph.png",
    "ch_hbo_family":         PH + "hbo-family-ph.png",
    "ch_hbo_signature":      PH + "hbo-signature-ph.png",
    "ch_anc":                PH + "anc-ph.png",
    "ch_dzmm_teleradyo":     PH + "dzmm-teleradyo-ph.png",
    "ch_one_news":           PH + "one-news-ph.png",
    "ch_one_ph":             PH + "one-ph-ph.png",
    "ch_one_sports":         PH + "one-sports-ph.png",
    "ch_one_sports_plus":    PH + "one-sports-plus-ph.png",
    "ch_pba_rush":           PH + "pba-rush-ph.png",
    "ch_pbo":                PH + "pinoy-box-office-ph.png",
    "ch_premier_sports":     PH + "premier-sports-ph.png",
    "ch_premier_sports_2":   PH + "premier-sports-2-ph.png",
    "ch_rptv":               PH + "rptv-ph.png",
    "ch_sari_sari":          PH + "sari-sari-channel-ph.png",
    "ch_spotv":              PH + "spotv-ph.png",
    "ch_spotv2":             PH + "spotv2-ph.png",
    "ch_tap_movies":         PH + "tap-movies-ph.png",
    "ch_tap_sports":         PH + "tap-sports-ph.png",
    "ch_tmc":                PH + "tmc-ph.png",
    "ch_buko":               PH + "buko-ph.png",
    "ch_nba_tv_philippines": PH + "nba-tv-philippines-ph.png",
    "ch_tvn_movies_pinoy":   PH + "tvn-movies-pinoy-ph.png",
    "ch_viva_cinema":        PH + "viva-cinema-ph.png",
    "ch_warner_tv":          PH + "warner-tv-ph.png",
    "ch_knowledge_channel":  PH + "knowledge-channel-ph.png",
    "ch_solar_sports":       PH + "solar-sports-ph.png",
    "ch_solarflix":          PH + "solar-flix-ph.png",
    "ch_kix":                PH + "kix-ph.png",
    "ch_aniplus":            PH + "aniplus-ph.png",
    ...
    "ch_cartoon_network":    INT + "cartoon-network-int.png",
    "ch_cna":                INT + "cna-int.png",
    "ch_cnn":                INT + "cnn-international-int.png",
    "ch_dazn_combat":        INT + "dazn-int.png",
    "ch_dazn_ringside":      INT + "dazn-int.png",
    ...
    "ch_nickelodeon":        INT + "nickelodeon-int.png",
    "ch_nick_jr":            INT + "nick-jr-int.png",
    "ch_nhk_world_japan":    INT + "nhk-world-japan-int.png",
    "ch_discovery_asia":     INT + "discovery-asia-int.png",
    "ch_afn":                INT + "asian-food-network-int.png",
    "ch_kbs_world":          INT + "kbs-world-int.png",
    "ch_disney_jr":          INT + "disney-jr-int.png",
    "ch_cartoonito":         INT + "cartoonito-int.png",
